statuses <- function(){
  structure(list(status = c("abandoned", "active", "concept", "inactive",
                            "moved", "suspended", "unsupported", "wip"), md_code = c("[![Project Status: Abandoned - Initial development has started, but there has not yet been a stable, usable release; the project has been abandoned and the author(s) do not intend on continuing development.](https://www.repostatus.org/badges/latest/abandoned.svg)](https://www.repostatus.org/#abandoned)",
                            ...
                            ), name = c("Project Status: Abandoned - Initial development has started, but there has not yet been a stable, usable release; the project has been abandoned and the author(s) do not intend on continuing development.",
                            ...
                            ), src = c("https://www.repostatus.org/badges/latest/abandoned.svg",
                                       ...
                                       "https://www.repostatus.org/badges/latest/wip.svg"), href = c("https://www.repostatus.org/#abandoned",
                                                                                                     ...
                                                                                                     "https://www.repostatus.org/#wip")), row.names = c(NA, -8L), class = c("tbl_df",
                                                                                                                                                                            "tbl", "data.frame"))
}
